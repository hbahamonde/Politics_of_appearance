...
\begin{center}
{\color{accent}\small\bfseries VISUAL FACTORIAL PROOF OF CONCEPT}\par
\vspace{2pt}
{\LARGE\bfseries Political Appearance as a Causal Cue}\par
\vspace{2pt}
{\large\bfseries A Matched-Identity Candidate Experiment in Finland}\par
\vspace{5pt}
...
\textbf{H1:} Appearance shifts perceived ideology after policy information is shown. \textbf{H2:} appearance--platform congruence increases vote probability, credibility, authenticity, political suitability, and perceived fit. \textbf{H3:} production-study effects vary with respondent ideology, class, knowledge, candidate gender, and country.

\newpage

\sectionbar{All proof-of-concept stimuli}
\begin{center}
...
Candidate 1 & \facetimg{../_static/appearance_experiment/images/candidates/candidate_01_v1.png} & \facetimg{../_static/appearance_experiment/images/candidates/candidate_01_v2.png} & \facetimg{../_static/appearance_experiment/images/candidates/candidate_01_v3.png} \\
Candidate 2 & \facetimg{../_static/appearance_experiment/images/candidates/candidate_02_v1.png} & \facetimg{../_static/appearance_experiment/images/candidates/candidate_02_v2.png} & \facetimg{../_static/appearance_experiment/images/candidates/candidate_02_v3.png} \\
Candidate 3 & \facetimg{../_static/appearance_experiment/images/candidates/candidate_03_v1.png} & \facetimg{../_static/appearance_experiment/images/candidates/candidate_03_v2.png} & \facetimg{../_static/appearance_experiment/images/candidates/candidate_03_v3.png} \\
Candidate 4 & \facetimg{../_static/appearance_experiment/images/candidates/candidate_04_v1.png} & \facetimg{../_static/appearance_experiment/images/candidates/candidate_04_v2.png} & \facetimg{../_static/appearance_experiment/images/candidates/candidate_04_v3.png}
\end{tabular}
\vspace{3pt}
...
-\{\mu(+1,-1)-\mu(-1,-1)\},
\]
where $\mu(a,p)=\mathbb{E}[Y\mid A=a,P=p]$. Random assignment identifies both quantities; standard errors cluster by respondent and identity in the production study.
...
\sectionbar{Prototype contribution}
The prototype delivers identity-matched images, independently randomizes appearance and two policy dimensions, prevents within-person identity repetition, randomizes the rated profile, and exports every assignment with choice time and outcomes. It does not claim that the three looks already possess the intended Finnish meanings.
